        ...
        <Fragment>
            <div className="newsletter-section">
                <div className="flex flex-col items-center w-fit gap-3">
                    <span className="font-medium text-md md:text-xl uppercase text-gray-500">Newsletter</span>
                    <span className="font-bold text-xs md:text-2xl uppercase">
                        Sign up for latest updates and offers
                    </span>
                    <div className="flex gap-2">
                        <input className='w-[150px] md:w-[250px] h-[40px] px-3 border border-gray-400 outline-gray-400' type="text" placeholder="Email Address" />
                        <button className='px-3 md:px-8 py-2 bg-purple-800 text-white'>Subscribe</button>
                    </div>
